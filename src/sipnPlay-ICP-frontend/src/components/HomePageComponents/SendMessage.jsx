...
const SendMessage = () => {
  ...
  return (
    <div
      id="contact-us"
      className="flex flex-col md:flex-row px-4 md:px-[9%] pb-[147px] relative z-20 overflow-hidden mt-20"
    >
      <h2 className="text-4xl md:text-6xl font-monckeberg mt-4 md:mt-[2%] text-white text-center md:text-left">
        Send us a message
      </h2>
      <form
        className="p-4 md:p-8 rounded-lg shadow-md w-full mt-4 md:mt-0 md:ml-10 bg-black bg-opacity-80"
        onSubmit={handleSubmit}
      >
        <div className="mb-4">
          <label
            className="block text-[14px] md:text-[22.5px] text-white font-adam font-bold text-sm mb-2"
            htmlFor="name"
          >
            YOUR NAME
          </label>
        ...
        <div
          className="absolute bottom-0 md:-bottom-[300px] md:-right-[200px] rounded-full h-[700px] blur-lg opacity-70 w-[700px] pointer-events-none"
          style={{
            backgroundImage:
              "radial-gradient(circle, rgba(136, 47, 93, 0.4), rgba(169, 62, 62, 0.2), rgba(37, 29, 118, 0.2), transparent)",
          }}
        ></div>
