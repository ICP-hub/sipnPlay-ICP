...
const Hero = () => {
  return (
    <section id="home" className="grid grid-cols-1 lg:grid-cols-2 mb-[20px] sm1:mb-[90px] sm:mb-[100px] md:mb-[80px] lg:mb-[30px] px-[8%]">
      {/* Left Div */}
      <div className="  lg:h-auto lg:border-t-[0.5px] lg:border-r-[0.5px] lg:border-white  xl:h-[722px] flex-1 flex-col items-center   justify-center bg-black text-white">
