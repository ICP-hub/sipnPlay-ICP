    ...
    <>
      ...
      >
        ...
        <div className="  lg:h-screen lg:border-t-[0.5px] lg:border-r-[0.5px] lg:border-white  xl:h-[722px] flex-1 flex-col items-center justify-center bg-black text-white">
          <div className="flex ml-[10%] pt-[45px] relative xl:pt-[98px] font-monckeberg lg:justify-start md:ml-[-65px] lg:ml-[-50px]   lg:pt-[151px] ">
            <p className="text-[42px] xl:text-8xl lg:text-6xl px-[9%] font-thin">
              GameFi
              <span
                className="text-[#EE3EC9] absolute right-[5%] top-[30px] ss4:right-[01%] dxs:right-[5%]
          ...
          <p className="mt-4 text-center text-[15px]  w-full md:text-[25px] font-bold lg:pr-[20%] lg:text-start lg:text-[15px] xl:pr-[20%] xl:text-left xl:text-[21px]  font-adam">
            ...
            Our games are designed to be hyper-casual, fun, and easy to
            understand. We're here to onboard web2 users to our web3 universe
            backed by a loyal community. Join our waitlist to get early access
            to our NFT passport.
          </p>
        </div>
        ...
        <div className=" lg:h-screen h-[442px]  xl:h-[722px] relative">
          <img
            className="w-[431px] lg:w-[100%] mx-auto mt-14  "
            draggable="false"
            src={nft}
          />
          <p className="font-monument absolute ss2:text-[100px] xxs1:w-[100%] sm1:-left-2 xl:left-0 bottom-8 font-bold opacity-10 w-full xxs1:text-[156px] xl:text-[200px] ">
            NFT
          </p>
          <p className="font-monument absolute left-0 bottom-0  opacity-10 font-bold text-[40px] xxs1:text-[55px] xl:text-[100px]">
            PASSPORT
          </p>
