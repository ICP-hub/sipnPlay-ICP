  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 mt-8 overflow-y-auto max-h-[70vh]">
          <div className="lg:pe-14 overflow-y-auto max-h-[70vh] border-white">
          ...
          <div className="lg:border-l-2 overflow-y-auto max-h-[70vh] lg:ps-14">
            ...
            <div className="flex justify-evenly">
              <div className="h-[132px] w-full mt-auto relative text-center pt-[45px] border border-[#EE3EC9]">
                <img
                  className="absolute rounded-full h-[60px] -top-8 left-1/2 -translate-x-1/2 border-2 border-gray-200"
                  src={userProfilePic}
                />
                <p className="font-adam font-[600]">Vatani</p>
                <p className="font-adam"> Level 3</p>
              ...
              <div className="h-[172px] w-full relative text-center pt-[45px] border border-[#EE3EC9]">
                <div className="h-3/4">
                  <img
                    className="absolute rounded-full h-[90px] -top-12 left-1/2 -translate-x-1/2 border-2 border-yellow-400 "
                    src={userProfilePic}
                  />
                  <img
                    className="absolute h-[90px] -top-28 left-1/2 -translate-x-1/2"
                    src={Crown}
                  />
                  <p className="font-adam mt-8 font-[600]">Vatani</p>
                  <p className="font-adam"> Level 3</p>
              ...
              <div className="h-1/2 w-full mt-auto relative text-center pt-8 border border-[#EE3EC9]">
                <img
                  className="absolute rounded-full h-[60px] -top-8 left-1/2 -translate-x-1/2 border-2 border-[#cd7f32] "
                  src={userProfilePic}
                />
                <p className="font-adam font-[600]">Vatani</p>
                <p className="font-adam"> Level 3</p>
