  ...
  return (
    <div>
      <div
        ...
        className="flex md:flex-col justify-around md:justify-start gap-2 md:gap-4 py-2 sm:py-4 text-sm sm:text-md md:text-xl lg:text-xl md:ps-8 md:pe-16 px-8 md:h-dvh md:border-r-2 md:border-t-2 md:border-b-2 border-[#3f3939] md:rounded-r-2xl"
      >
        <div
