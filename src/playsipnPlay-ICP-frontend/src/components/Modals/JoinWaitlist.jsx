        ...
        >
          ...
          >
            <p className="text-white absolute font-monckeberg top-[20%] left-[5%] md:top-[20%] md:left-[25%]">
              <span className="text-5xl md:text-5xl lg:text-5xl lg1:text-7xl">
                Join{" "}
              </span>
              <br />
              <span className="md:text-3xl lg:text-3xl lg1:text-5xl">
                Waitlist
              </span>
            </p>
            <div className="relative flex  md:block">
              ...
              />
              <img
                className="w-[200px] transform -scale-x-100 md:transform-none md:w-[200px] lg:w-[313px]  md:mt-0 md:absolute top-0 right-0 md:top-auto md:right-auto md:-bottom-9 md:-left-9 "
                draggable="false"
                src={alien}
              />
            </div>
            ...
            <div className="w-full md:w-auto mt-8 md:mt-0">
              ...
              <form onSubmit={handleSubmit} className="w-full   ">
                <div className=" mb-4 ">
                  <label
                    className="block text-white font-adam font-bold text-sm  md:mb-0.2"
                    htmlFor="name"
                  >
                    YOUR NAME
                  </label>
              ...
              <div className="flex flex-col md:flex-row md:justify-end mt-12 mb-7 text-white gap-3 items-center md:items-end">
                <p className="font-adam font-[300] text-white text-[20px] text-center md:text-left">
                  Follow us on
                </p>
                <div className="flex gap-3 mt-2 md:mt-0">
                  <Link
                    to="https://discord.com/invite/6PmNCezvG4"
                    target="__blank"
                  >
                    <BsDiscord size={33} />
                  </Link>
