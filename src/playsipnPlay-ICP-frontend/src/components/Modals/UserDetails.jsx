      ...
      {detailsModalOpen && (
        <div className=" inset-0 z-20 flex items-center justify-center ">
          <div
            ...
            className="absolute right-8 top-16 p-4 my-4 md:top-20 md:p-6 md:right-16 md:h-80 lg:top-16 lg:right-24 lg:h-96 lg:w-72 lg:p-8 rounded-3xl flex flex-col justify-center items-center gap-4 backdrop-filter backdrop-blur-lg bg-black"
            ref={ref}
          >
