    ...
    <div>
      ...
      >
        <div className="bg-black p-[15px] md:p-[20px] relative w-[80%] md:w-[440px] border border-[#696969] rounded-xl">
          <img
            className="md:absolute mx-auto left-3 top-4 lg:w-[101px] w-[91px] "
            draggable="false"
            src={logo}
          />
          <p className="text-center text-white font-monckeberg mt-4 md:mt-0 text-2xl md:text-2xl lg:text-3xl lg1:text-4xl">
            Wallets{" "}
          </p>
